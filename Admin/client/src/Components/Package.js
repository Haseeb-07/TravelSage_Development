...
const Package = ({ _id, name, numberOfPersons, destinations, startDate, endDate, price, onDelete, onSave }) => {
        ...
        {editing ? (
          <Form>
            ...
            <Form.Group controlId="numberOfPersons">
              ...
              <Form.Control type="number" name="numberOfPersons" value={editedPackage.numberOfPersons} onChange={handleChange} />
            </Form.Group>
